...
txt_hintname = "ФИО"
txt_hintage = "0"
txt_test1 = 'Лягте на спину и замерьте пульс за 15 секунд. Нажчите кнопку "Начать первый тест", чтобы запустить таймер.\nРезультат запишите в соответствующее поле.'
...
txt_res3 ="средняя,советуем проверится у врача"
